...
<head>
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="Welcome.jsp">Mediplus</a>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	...
          	<!-- 	<span class="subheading">Welcome to Mediplus</span> -->
	            <h1 class="mb-4">We Care<br> For You</h1>
	            </div>
          </div>
        </div>
      </div>
    	...
    	<div class="container">
    		 <div class="row d-flex">
    			 <div class="col-md-6 col-lg-5 d-flex">
    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(images/image_4.jpg);">
    				</div>
    			</div>  
    			<div class="col-md-6 col-lg-7 pl-lg-5 py-md-5">
    				<div class="py-md-5">
			          ...
			          -->
			         <form action="PatientServlet" class="appointment-form ftco-animate" method="post">
		        		<center><h3>Patient Information</h3></center>
		    				<div class="form-group">.
		    				<div class="input-wrap">
			    					<input type="text" class="form-control" placeholder="Patient Reg no." name="pid" required>
			    				</div>
			    				<br>
			    					<div class="input-wrap">
			    					<input type="text" class="form-control" placeholder="Patient Name" name="pname" required>
			    				</div>
			    				<br>
			    				<div class="input-wrap">
			    					<input type="text" class="form-control" placeholder="Adrress" name="address" required>
			    				</div>
			    				<br>
			    				<div class="input-wrap">
			    					Patient Type <input type="radio" name="ptype" value="IP"> IP <input type="radio" name="ptype" value="OP"> OP <br>

			    				</div>
		    			<br>
			    				<div class="input-wrap">
			    					<input type="text" class="form-control" placeholder="Bed No" name="bedno" required>
			    				</div>
			    				<br>
			    				<div class="input-wrap">
			    					<input type="text" class="form-control" placeholder="Doctor Name" name="doctor" required>
			    				</div>
			    				<br>
			    				<div class="input-wrap">
			          ...
			          <center>   <input type="submit" value="submit" class="btn btn-secondary py-2 px-10">
...
<!-- Review    <section class="ftco-section testimony-section img" style="background-image: url(images/bg_3.jpg);">
    	<div class="overlay"></div>
      <div class="container">
